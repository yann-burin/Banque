...
public class CalculDebitCreditMensuel {
    ...
    public static void main(String[] args) throws IOException, SQLException, ParseException {
        ...
        try (PreparedStatement statementHistorique = connectionDB.prepareStatement(sqlHistorique,
            ...
            while (rsHistorique.next()) {
                ...
                if ((Integer.parseInt(format_mois.format(date)) != mois
                        || Integer.parseInt(format_annee.format(date)) != annee)) {
                    WriteFile.writeFile("INFO", "-------------> date: " + date + ", annee: " + annee + ", mois: " + mois
                            + ", cumulEurosCalc: " + cumulEurosCalc + ",  debit: " + debit + ", credit: " + credit,
                            logFile);
                    ...
                    // WriteFile.writeFile("INFO", "-------------> insert => debit: " + debit + " -
                    // credit: " + credit, logFile);
                ...
                // WriteFile.writeFile("INFO", "-------------> date: "+date+", annee: "+annee+",
                // mois: "+mois, logFile);
            }
        }
    ...
    public static void MajImportFichiers(Connection connection, String compte, int mois, int annee, Double sommeDebits,
            Double sommeCredits, Double solde) throws SQLException {
        int count = 0;
        int batchSize = 20;
