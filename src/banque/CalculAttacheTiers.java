            ...
            while (rsTiers.next()) {
                ...
                try ( PreparedStatement statementHistorique = connectionDB.prepareStatement(sqlHistorique);  
                    ...
                    while (rsHistorique.next()) {
                        ...
                        WriteFile.writeFile("INFO", "-> critere:"+critere+" > update historique set critere = '"+critere+"' where compte='"+compte+"' and euros="+euros+" and libelle='"+libelle+"' ", logFile);
                        razAttacheTiers("update historique set critere = '" + critere+"' where compte='"+compte+"' and euros="+euros+" and libelle='"+libelle+"' ",connectionDB);
