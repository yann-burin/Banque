...
public class exampleJframe extends JFrame {
    ...
    public exampleJframe() {
        ...
        try {
            ...
            Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/banque", "root", "Administrator*");
            ...
            sSql=sSql + "FROM historique historique, Correspondances Correspondances, Tiers Tiers, Categories Categories " ;
